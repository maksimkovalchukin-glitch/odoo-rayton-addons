{
    'name': 'Rayton Project Hub',
    'version': '17.0.1.0.0',
    'summary': 'Ініціювати проект з CRM нагоди, прив\'язати Discuss канал, відправити вебхук на n8n',
    'description': """
        Єдиний модуль який:
        ...
        6. Показує бокову панель чату в списку задач проекту
    """,
    'category': 'Project',
    'author': 'Rayton',
